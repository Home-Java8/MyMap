...
//        String []values = {"Before","Java","the","way","to","loop","through","an","array","involved","getting","the","number","of","elements","in","the","array","With","the","advent","of","Java","5","we","can","make","our","for","loops","a","little","cleaner","and","easier","to","read","so","looping","through","an","array","is","even","easier","Here's","a","complete","source","code","_example","that","demonstrates","the","new"};
